        ...
        <section className='about'>
            ...
            <div className='about-holder'>
                ...
                <p className='about-me'>Hello world! My name is Samuel Varney. I am a full stack web developer
                    ...
                    cheese lox spread. Can't wait to go back and eat some again. ANY ways -- what else to talk about?
                    Weather is weather outside. Looks like there some trees, and other plants. Color is
                    just light radiation, isn't that neat? Alright later guys, gotta go figure out how to conditionally render
